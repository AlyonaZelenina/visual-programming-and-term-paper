...
|13| Сварич Вадим Юрьевич | Разработка игры на Unity|
|14| Цибенко Марія Володимирівна | Розробити модуль кодогенерації моделей, маршрутизатора, і валідаторів на основі OpenAPI специфікації сервісів.|
|15| Щеголь Андрій Андрійович |Розробити підсистему генерації JWT токенів доступу на основі form-based механізму аутентифікації. (частина 1)|
|16| Рудой Дмитро Ігорович | Signup flow (разработать модуль регистрации учётных данных системы управления учётными данными) (часть 3)|
|17| Зеленіна Альона Віталіївна | Signup flow (разработать модуль регистрации учётных данных системы управления учётными данными) (часть 2)|  
